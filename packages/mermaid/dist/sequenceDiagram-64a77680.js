import { g as getAccTitle, D as getDiagramTitle, C as setDiagramTitle, c as getConfig, s as setAccTitle, b as setAccDescription, a as getAccDescription, E as clear$1, l as log, d as sanitizeText, e as dist, f as common, Y as parseFontSize, a4 as hasKatex, r as renderKatex, _ as getConfig$1, a5 as ZERO_WIDTH_SPACE, a6 as calculateMathMLDimensions, h as assignWithDepth, j as d3select, k as configureSvgSize, A as utils } from "./mermaid-ae6fd49a.js";
import { d as drawRect$1, a as drawBackgroundRect$1, b as drawEmbeddedImage, c as drawImage, e as getTextObj$1, g as getNoteRect$1 } from "./svgDrawCommon-adcfba6a.js";
var parser = function() {
...
const drawMessage = async function(diagram2, msgModel, lineStartY, diagObj) {
  ...
  hasKatex(textObj.text) ? await drawKatex(g, textObj, { startx, stopx, starty: lineStartY }) : drawText(g, textObj);
  const textWidth = textDims.width;
  let line;
  if (startx === stopx) {
    if (conf.rightAngles) {
  ...
  if (sequenceVisible || conf.showSequenceNumbers) {
    ...
    g.append("text").attr("x", startx).attr("y", lineStartY + 4).attr("font-family", "sans-serif").attr("font-size", "12px").attr("text-anchor", "middle").attr("class", "sequenceNumber").text(sequenceIndex);
  }
};
    ...
    switch (msg.type) {
      ...
      default:
        try {
          ...
          await drawMessage(diagram2, msgModel, lineStartY, diagObj);
