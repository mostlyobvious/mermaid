import { d as ut, c as F, G as Re, s as rt, g as at, a as lt, b as ct, C as ot, D as ht, f as v, E as At, l as pt, A as We, j as z } from "./mermaid-3f142303.js";
var Ve = function() {
...
const V = (e) => v.sanitizeText(e, F()), w = function(e) {
  ...
  pt.debug("Adding relation: " + JSON.stringify(e)), Ae(e.id1), Ae(e.id2), e.id1 = w(e.id1).className, e.id2 = w(e.id2).className, e.relationTitle1 = v.sanitizeText(e.relationTitle1.trim(), F()), e.relationTitle2 = v.sanitizeText(e.relationTitle2.trim(), F()), Pe.push(e);
}, kt = function(e, i) {
